...
public class Rotor {
    ...
    public void load() {
        ...
        topRegion = Core.atlas.find(topBladeName == null ? name + "-top" : "aor" + topBladeName + "-top");
        topRegionOutline = Core.atlas.find(topBladeName == null ? name + "-top-outline" : "aor" + topBladeName + "-top-outline");
    }
